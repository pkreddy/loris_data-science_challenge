1.About the data science challenge
The data is the DailyDialogue dataset, which contains 10,000+ text-based dialogues between two people. A full description of the dataset is here and the data can be downloaded in a single zip file here.
